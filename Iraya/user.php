<?php
    ...
    function addJournal($userId, $title, $content, $sticker) {
        global $conn;
        $params = [$userId, $title, $content, $sticker];

        $stmnt = $conn->execute_query("insert into journal(user_id,journal_title,
            journal_content,sticker_name) values(?,?,?,?)", $params);
    }
